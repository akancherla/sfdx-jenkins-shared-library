                        ...
                        withCredentials([file(credentialsId: sfdxUrlCredentialId, variable: 'server_key_file')]) {
                            ...
                            stage('Authorize DevHub') {
                                ...
                                //    withCredentials([file(credentialsId: sfdxUrlCredentialId, variable: 'server_key_file')]) {
                                    ...
                                    shWithStatus("sfdx auth:jwt:grant --instanceurl=${sfInstanceURL} --clientid=${sfConsumerKey} --username=${sfUserName} --jwtkeyfile=C:\\PC_Tools\\openssl\\jwt\\server.key --setdefaultdevhubusername --setalias=${authorizeDevHub}")
